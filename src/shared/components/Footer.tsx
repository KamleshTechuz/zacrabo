...
const SocialLinks = ({data}: {data: SocialData}) => <a href={data.url} className={data.class} aria-label={data.label} target="_blank" rel="noreferrer"><i className={data.icon}></i></a>;
